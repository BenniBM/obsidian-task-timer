    ...
    >
        {#each Array.from(timers) as [timerId, timer] (timerId)}
            <div class="mb-2.5">
                ...
                <span
                    class="mr-3 flex-1 text-sm block truncate"
                    title={timer.description}>{timer.description}</span
                >
                <div class="flex justify-start mt-2 gap-2">
                    <button
                        class="px-4 py-1 rounded-md border-2 border-background-modifier-border bg-background-primary cursor-pointer text-sm transition-all duration-200 hover:bg-background-modifier-hover hover:-translate-y-0.5"
                        on:click={() =>
                            timer.isPaused
                    ...
                    <button
                        class="px-4 py-1 rounded-md border-2 border-text-error text-error bg-background-primary cursor-pointer text-sm transition-all duration-200 hover:bg-text-error hover:text-background-primary hover:-translate-y-0.5"
